...
$iterative_prime_number_generator = new IterativePrimeNumberGenerator();

//uses dependecy injection
$prime_numbers_obj = new PrimeNumbers($iterative_prime_number_generator, $default_from, $default_to);
...
<div style="color: #009900;">
    <h3>Answer: </h3>
    <h4>Using the default range 1 - 500  (Iterative)</h4>
...
<div style="color: #ff0000">
    ...
    if(isset($_POST['to']))
    {
        ...
        $prime_numbers_obj = new PrimeNumbers($iterative_prime_number_generator, $from, $to);
        $prime_numbers = $prime_numbers_obj->getPrimeNumbers();
